  ...
  return (
    <main className="min-h-screen py-20 md:py-32 px-6 sm:px-12 md:px-24 bg-surface max-w-screen-2xl mx-auto">
      <div className="max-w-[800px] mx-auto">
        <Link href={`/${locale}`} className="inline-flex items-center text-on-surface-variant hover:text-on-background transition-colors mb-12 text-label">
        ...
        <div 
          className="space-y-8 text-on-surface-variant font-sans font-light text-sm leading-[1.6] [&_h2]:font-serif [&_h2]:text-3xl [&_h2]:font-normal [&_h2]:text-on-background [&_h2]:mt-16 [&_h2]:mb-6 [&_h3]:text-label [&_h3]:text-on-background [&_h3]:mt-8 [&_h3]:mb-4 [&_p]:mb-6 [&_p]:text-on-surface-variant [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-6 [&_ul]:space-y-3 [&_ul]:text-on-surface-variant [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-6 [&_ol]:space-y-3 [&_ol]:text-on-surface-variant [&_li]:pl-2 [&_a]:font-normal [&_a]:underline [&_a]:decoration-outline/30 [&_a]:underline-offset-4 [&_a]:hover:decoration-on-background [&_a]:text-on-background [&_a]:transition-colors"
